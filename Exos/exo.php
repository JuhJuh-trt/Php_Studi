<?php
define("Nom_Site", "www.monsiteweb.com"); # on initialise le nom du site
$utilisateur = readline("Comment puis-je vous appeler ? "); # demande à l’utilisateur de saisir son prénom
echo "Bonjour $utilisateur et bienvenue sur ", Nom_Site , "!\n"; # on affiche la phrase d’accueil “Bonjour…”
# pour simuler la discussion, on utilise une boucle jusqu’à ce que FIN soit saisi par l’utilisateur
while ($saisie = readline("Comme puis-je vous aider ? (taper FIN pour quitter) ") != "FIN"){
    echo "Désolé, le service n'est pas implémenté pour vous répondre...\n";
}
echo "Merci de votre visite $utilisateur et a bientot sur ", Nom_Site, "!"; # on affiche la phrase de fin “Au revoir…”
?>
